...
##---------------------------------------------------------------------------------------------------------
# Load the KNN model
mfile = BytesIO(requests.get('https://github.com/Sonal008/Document-Classification-NLP/blob/main/knn_model.pkl?raw=true').content)
model = load(mfile)
mfile1 = BytesIO(requests.get('https://github.com/Sonal008/Document-Classification-NLP/blob/main/tfidf.pkl?raw=true').content)
model1 = load(mfile1)

# Load resume dataset
word = pd.read_csv('Dataset/Resume word counts.csv').drop(columns=['Resume'])
clean = pd.read_csv('Dataset/Resume cleaned.csv')
...
if menu_id == 'Resume Classification':
    ...
    def extract_skills(resume_text):
        ...
        data = pd.read_csv("Dataset/skillset.csv") 
